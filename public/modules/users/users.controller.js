...
let UsersController = class UsersController {
    ...
    async login(userDto) {
        try {
            ...
            throw new common_1.HttpException('Erro ao fazer login. Verifique suas credenciais.', common_1.HttpStatus.UNAUTHORIZED);
        }
    }
    async logout(id) {
        try {
            ...
            throw new common_1.HttpException('Erro ao fazer logout.', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async create(data) {
        try {
    ...
    async getUserStatus(req) {
        ...
        if (!isActive) {
            ...
            throw new common_1.HttpException('Usuário desativado. Logout realizado.', common_1.HttpStatus.UNAUTHORIZED);
        }
        return { isActive };
    }
    async findAll() {
    ...
    async desactiveUserById(id) {
        try {
            ...
            throw new common_1.HttpException('Erro ao deletar usuário.', common_1.HttpStatus.BAD_REQUEST);
        }
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "desactiveUserById", null);
